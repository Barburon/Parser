...
public class Main {
    public static void main(String[] args) {
        ...
        List<Article> electronicaList = service.toParse(electronica);
        List<Article> sportList = service.toParse(sport);
        List<Article> supermarketList = service.toParse(supermarket);
